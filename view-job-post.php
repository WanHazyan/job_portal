...
<div class="navbar1">
  ...
  <?php
    ...
    $sql = "SELECT * FROM job_post INNER JOIN admin ON job_post.id_admin=admin.id_admin WHERE id_jobpost='$_GET[id]'";
      ...
      <div class="container">
        <div class="row">          
          <div class="col-md-9 bg-white padding-2">
            ...
            <hr>
            <div>
              <p><span class="margin-right-10"><i class="fa fa-location-arrow text-green"></i> <?php echo $row['typeofjob']; ?></span> <i class="fa fa-calendar text-green"></i> <?php echo date("d-M-Y", strtotime($row['createdat'])); ?></p>              
            </div>
            <div>
